    ...
    static calculateVerdict(composition: CompositionRow[]): Verdict {
        ...
        if (totalPercentage === 0)
            return {
                ...
                description: "Introduce la composición para analizar.",
                color: "gray",
                intensity: 0,
            };
        ...
        if (polyAcrylicPerc > 50) {
            return {
                label: "Plástico Caro",
                description:
                    "La mayoría de esta prenda es petróleo. Prepárate para sudar y que aparezcan bolitas rápido.",
                color: "red",
        ...
        if (viscoseModalPerc > 30) {
            return {
                ...
                description:
                    "Muy agradable al tacto, pero cuidado al lavarla: tiende a deformarse y encoger con facilidad.",
                color: "yellow",
        ...
        if (naturalBreathablePerc > 70) {
            return {
                ...
                description:
                    "Prenda transpirable y duradera. Ideal para pieles sensibles y uso prolongado.",
                color: "emerald",
        ...
        if (syntheticPerc > 80) {
            return {
                ...
                description:
                    "A menos que sea ropa de deporte específica, estás pagando por plástico puro.",
                color: "red",
        ...
        if (nobleFiberPerc >= 50) {
            return {
                label: "Lujo Real",
                description:
                    "Una inversión en comodidad y durabilidad. Trátala con el respeto que merece.",
                color: "indigo",
        ...
        return {
            ...
            description:
                "Una combinación funcional, probablemente busca balancear coste y durabilidad.",
            color: "blue",
            intensity: 0.5,
        };
    }
