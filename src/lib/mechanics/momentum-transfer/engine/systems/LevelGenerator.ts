...
export class LevelGenerator {
    public static initLevel(): { player: Entity, enemies: Entity[], obstacles: Obstacle[] } {
        ...
        const enemies: Entity[] = [
            { id: 1, pos: { x: w * 0.5, y: h * 0.5 }, vel: { x: 0, y: 0 }, radius: 25, type: 'enemy', isDead: false, color: ENEMY_COLOR },
            { id: 2, pos: { x: w * 0.6, y: h * 0.3 }, vel: { x: 0, y: 0 }, radius: 25, type: 'enemy', isDead: false, color: ENEMY_COLOR },
            { id: 3, pos: { x: w * 0.6, y: h * 0.7 }, vel: { x: 0, y: 0 }, radius: 25, type: 'enemy', isDead: false, color: ENEMY_COLOR },
            { id: 4, pos: { x: w * 0.8, y: h * 0.5 }, vel: { x: 0, y: 0 }, radius: 35, type: 'enemy', isDead: false, color: ENEMY_COLOR }
        ];
