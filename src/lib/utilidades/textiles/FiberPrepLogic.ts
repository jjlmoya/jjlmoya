    ...
    static getProtocol(fiberType: FiberType) {
        if (fiberType === 'protein') {
            return {
                ...
                description: 'Las fibras animales requieren un ambiente ácido y sales metálicas para abrir sus escamas.',
                steps: [
        ...
        return {
            ...
            description: 'Las fibras vegetales no tienen afinidad natural por el alumbre; necesitan un pre-tratamiento con taninos.',
            steps: [
