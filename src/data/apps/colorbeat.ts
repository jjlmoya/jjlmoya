...
export const colorbeat: Application = {
    ...
    "description": "Domina el juego pulsando en el momento exacto al ritmo de los pulsos de color. Cada movimiento cuenta y cada beat te acerca a la cima.",
    ...
    "media": {
        ...
        "screenshots": [
            "/assets/apps/colorbeat/screenshot_1.png"
        ]
    },
    "stores": {
