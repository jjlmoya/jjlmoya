...
export const monmons: Application = {
    ...
    "tagline": "",
    "description": "Monmons es un RPG de gestión de monstruos en pixel art centrado en tu Base de Operaciones. Equilibra la exploración narrativa con desafíos de alto nivel en una experiencia retro-moderna optimizada para móvil.",
    "philosophy": "Foco absoluto en la estrategia de combate y el entrenamiento. Un sistema de tipos refinado y una progresión directa donde el crecimiento de tus Monmons es el único protagonista.",
    "concept": {
    ...
    "media": {
        ...
        "screenshots": [
            "/assets/apps/monmons/screenshot_real.png"
        ]
    },
    "stores": {
        "googlePlay": "",
