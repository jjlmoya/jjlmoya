export type CategoryId = 'exploration' | 'food' | 'learning' | 'creativity' | 'social' | 'observation' | 'wellness';
...
export const ADVENTURES: Adventure[] = [
    ...
    { id: 137, text: "Recorta una noticia de un periódico físico (o imprime una online) y guárdala.", categoryId: "exploration" },
    ...
    { id: 159, text: "Busca una planta que crezca en una grieta y hazle una foto.", categoryId: "creativity" },
    ...
    { id: 169, text: "Cierra los ojos y trata de recordar el plano de tu casa habitación por habitación.", categoryId: "wellness" },
    ...
    { id: 183, text: "Fíjate en los tipos de ventanas que hay en tu calle (madera, aluminio, modernas...).", categoryId: "observation" },
    { id: 184, text: "Escribe un mensaje anónimo de ánimo y ponlo tras el limpiaparabrisas de un coche.", categoryId: "social" },
    { id: 185, text: "Dibuja un círculo perfecto a mano alzada (o inténtalo).", categoryId: "creativity" },
    { id: 186, text: "Mira una charla TED sobre un tema que desconozcas.", categoryId: "learning" },
    { id: 187, text: "Bebe tu bebida habitual pero a una temperatura distinta (té frío, café helado...).", categoryId: "food" },
    ...
    { id: 195, text: "Come una fruta que debas pelar con las manos (mandarina, plátano...).", categoryId: "wellness" },
    ...
    { id: 207, text: "Encuentra 3 elementos de metal en el exterior y tócalos (¡con cuidado!).", categoryId: "observation" },
    { id: 208, text: "Aprende qué es un 'palíndromo' y encuentra 3 ejemplos.", categoryId: "learning" },
    { id: 209, text: "Haz un cumplido a un compañero de trabajo sobre algo que no sea su trabajo.", categoryId: "social" },
    ...
    { id: 214, text: "Averigua qué fruta es la más popular en el país más lejano que puedas pensar.", categoryId: "learning" },
    { id: 215, text: "Fíjate en las formas de los pomos de las puertas.", categoryId: "observation" },
    { id: 216, text: "Inventa un nombre para un color que no exista (ej. azul-queso).", categoryId: "creativity" },
    ...
    { id: 232, text: "Busca un banco que mire al tráfico y quédate 2 minutos observando los modelos de coches.", categoryId: "exploration" },
    ...
    { id: 238, text: "Cierra los ojos y camina unos pasos en línea recta (área segura).", categoryId: "observation" },
    ...
    { id: 244, text: "Escribe 3 frases de gratitud en tu diario o libreta.", categoryId: "wellness" },
    ...
    { id: 248, text: "Fíjate en la cantidad de luz solar que entra en cada habitación hoy.", categoryId: "observation" },
    ...
    { id: 251, text: "Aprende a hacer un nudo de corbata diferente (o por primera vez).", categoryId: "learning" },
    ...
    { id: 254, text: "Ordena tus libros de una forma diferente (por altura, por color...).", categoryId: "wellness" },
    { id: 255, text: "Pregunta a un bibliotecario por una sección de la biblioteca que casi nadie visite.", categoryId: "exploration" },
    { id: 256, text: "Aprende 3 hitos de la historia de la aviación.", categoryId: "learning" },
    { id: 257, text: "Cierra los ojos e intenta adivinar qué hora es antes de mirar el reloj.", categoryId: "observation" },
    ...
    { id: 261, text: "Nota la suavidad o rugosidad de la tela de lo que llevas puesto.", categoryId: "observation" },
    ...
    { id: 265, text: "Ve a un cementerio antiguo y lee los epitafios por pura curiosidad histórica.", categoryId: "exploration" },
    { id: 266, text: "Fíjate en los tipos de piedras que se usan en las fachadas de tu zona.", categoryId: "observation" },
    ...
    { id: 269, text: "Pregunta en la oficina de turismo algo sobre tu propia ciudad.", categoryId: "exploration" },
    { id: 270, text: "Dibuja a un monstruo que represente tu mayor miedo, pero hazle un sombrero gracioso.", categoryId: "creativity" },
    { id: 271, text: "Aprende de dónde viene la palabra 'salario'.", categoryId: "learning" },
    { id: 272, text: "Fíjate en el sonido del clic al abrir y cerrar una puerta.", categoryId: "observation" },
    { id: 273, text: "Haz una lista de 5 películas que te harían llorar.", categoryId: "wellness" },
    { id: 274, text: "Busca un objeto en tu casa que tenga una historia especial y cuéntala a alguien.", categoryId: "social" },
    { id: 275, text: "Prueba a beber tu bebida favorita con una pajita (si no sueles hacerlo).", categoryId: "food" },
    { id: 276, text: "Trata de encontrar 10 objetos circulares en tu habitación.", categoryId: "observation" },
    { id: 277, text: "Lleva un sombrero hoy, aunque sea un rato.", categoryId: "wellness" },
    { id: 278, text: "Pregunta a tus abuelos qué era lo que más les asustaba de niños.", categoryId: "social" },
    ...
    { id: 283, text: "Escucha un disco de jazz mientras haces una tarea rutinaria.", categoryId: "learning" },
    { id: 284, text: "Toma una foto de un objeto muy cotidiano desde un ángulo extraño.", categoryId: "creativity" },
    { id: 285, text: "Visita una iglesia o lugar de culto antiguo solo por su arquitectura.", categoryId: "exploration" },
    ...
    { id: 289, text: "Haz sonar tus nudillos y date cuenta de cómo se siente.", categoryId: "wellness" },
    ...
    { id: 293, text: "Escribe una lista de 3 sueños que recuerdes haber tenido.", categoryId: "wellness" },
    ...
    { id: 296, text: "Mira un mapa mundi y encuentra un país del que no sepas nada.", categoryId: "learning" },
    ...
    { id: 299, text: "Nota el calor del sol a través de un cristal hoy.", categoryId: "observation" },
    ...
    { id: 303, text: "Escribe un mensaje de agradecimiento a un amigo por algo que ocurrió hace tiempo.", categoryId: "social" }
];
