    ...
    utilities: [
        {
            ...
            description:
                "Diseña la masa perfecta. Controla la hidratación, la sal y la fermentación.",
            color: "#f97316",
        },
        {
        ...
        },
        {
            ...
            description:
                "Adapta recetas a cualquier molde. Calcula el factor multiplicador exacto.",
            color: "#f43f5e",
        },
        {
            ...
            description:
                "Regla de tres automática para adaptar ingredientes a más o menos comensales.",
            color: "#fbbf24",
        },
        {
            ...
            description:
                "Controla horno, fuego y reposo a la vez. Crea tantos temporizadores como necesites.",
            color: "#f97316",
        },
        {
            ...
            description:
                "Calcula los refrescos perfectos. Control total sobre ratios, hidratación y desperdicio.",
            color: "#f59e0b",
        },
        {
        ...
        },
        {
            ...
            description:
                "Encuentra el material ideal y aprende su mantenimiento: Hierro, Acero, Cobre o Antiadherente.",
            color: "#475569",
        },
        {
