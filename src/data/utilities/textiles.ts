...
export const TEXTILE_DATA: Record<string, TextileData> = {
    ...
    cashmere: {
        name: "Cashmere",
        description:
            "Fibra de lujo de cabra de Cachemira. Extremadamente suave, ligera y 8 veces más cálida que la lana.",
        family: "natural",
    ...
    mohair: {
        name: "Mohair",
        description:
            'La "fibra de diamante" de la cabra de Angora. Brillo natural, muy resistente y elástica.',
        family: "natural",
    ...
    angora: {
        name: "Angora",
        description:
            'Pelo del conejo de Angora. Conocido por su efecto "halo" esponjoso, ligereza extrema y calidez superior.',
        family: "natural",
        ...
        warmth: 10,
        washing:
            "EXTREMA PRECAUCIÓN. A mano, agua fría, detergente neutro. No sumergir mucho tiempo.",
    ...
    alpaca: {
        name: "Alpaca",
        description:
            "Tesoro de los Andes. Fibra hueca, térmica, hipoalergénica (sin lanolina) y sedosa.",
        family: "natural",
...
export const BURN_OPTIONS = {
    flame: {
        cellulosic:
            "Arde RÁPIDO y con BRILLO (Llama amarilla). No se funde. Sigue ardiendo al retirar.",
        protein:
            "Arde LENTAMENTE, chisporrotea y se ENCOGE alejándose de la llama. Se autoextingue al retirar.",
