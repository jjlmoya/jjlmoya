...
export const healthSection: SectionData = {
    ...
    utilities: [
        ...
        {
            href: "/utilidades/conversor-unidades-analitica-sangre/",
            iconBg: "mdi:water-percent",
            iconFg: "mdi:calculator-variant",
            title: "Conversor Analíticas",
            description: "Calculadora de conversión entre mg/dL y mmol/L para glucosa, colesterol y más.",
            color: "#e63946",
        },
        {
            href: "/utilidades/distancia-lectura/",
            iconBg: "mdi:eye-outline",
            iconFg: "mdi:ruler",
